 ...
 * {@link Unit}s or {@link javafx.scene.image.Image}s.
...
public class FlyweightFactory<T>
{
	 ...
	 */
	public boolean put(int hash, T element)
	{
		Integer key = Integer.valueOf(hash);
		if (!map.containsKey(key))
		{
	...
	/**
	 * Checks if this factory already has the provided elt
	 * @param value the element to search in the factory
	 * @return true if this element is already part oft this factory, false otherwise
	 */
