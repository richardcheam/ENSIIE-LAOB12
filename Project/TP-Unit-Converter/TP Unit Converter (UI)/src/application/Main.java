...
public class Main extends Application
{
	...
	public void start(Stage primaryStage)
	{
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("ConverterFrame.fxml"));
		BorderPane root = null;
		try
		{
			/*
			 * TODO 000 Main#start Complete ConverterFrame.fxml with SceneBuilder
			 * until every FXML annotated attribute defined in Controller is assigned
		 ...
		 * Setup App icon
		 */
		primaryStage.setTitle("Unit Converter v1.0");
		Image image = new Image("icons/speed-48.png");
		if (!image.isError())
		{
